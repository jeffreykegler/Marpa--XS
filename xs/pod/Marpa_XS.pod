...
Grammars are
L<C<Marpa::XS::Grammar>|Marpa::XS::Grammar> objects.
The reading of input and the evaluation of the parse
according to the semantics is performed by
L<C<Marpa::XS::Recognizer>|Marpa::XS::Recognizer> objects.
...
L<Marpa::XS::Vocabulary> is intended as a quick refresher in
parsing terminology,
