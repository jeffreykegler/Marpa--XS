...
package Marpa::PP::Internal::License;
...
This document is not part of the Marpa or Marpa::PP source.
...
In the Marpa::PP distribution, the GNU Lesser General Public License
...
sub Marpa::PP::License::file_license_problems {
    my ( $filename, $verbose ) = @_;
    $verbose //= 1;
    my @problems = ();
    CHECK_VS_ORIGINAL: {
